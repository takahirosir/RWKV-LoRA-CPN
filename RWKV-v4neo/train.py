...
if __name__ == "__main__":
    ...
    # args:
    #Namespace(
    # load_model='/workspaces/RWKV-LoRA-CPN/models/RWKV-4-Pile-3B-Chn-testNovel-done-ctx2048-20230312.pth', 
    # wandb='', 
    # proj_dir='/workspaces/RWKV-LoRA-CPN/project/lora_checkpoints', 
    # random_seed=-1, data_file='/workspaces/RWKV-LoRA-CPN/datasets/_text_document', 
    # data_type='binidx', 
    # vocab_size=50277, 
    # ctx_len=70, 
    # epoch_steps=1000, 
